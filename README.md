...
| `MEETING_ID` | Meeting ID to join; if empty, a new meeting is created | No |
| `VERSION_TAG` | Version tag of the agent; if empty, the backend dispatches the latest version | No |
